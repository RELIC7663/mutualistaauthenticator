...
class appController {
  ...
  Future<void> loginAsync(String url, String cedula) async {
    ...
    if (!response.isSuccess!) {
      ...
      await databaseHelper.updateDbenty(Dbenty(keys: 'USER_ID', value: loginResponse.idResponse.toString())); // Guarda el número de intentos
